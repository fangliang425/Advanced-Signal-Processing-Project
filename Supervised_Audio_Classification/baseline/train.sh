...
# author: xiehuang
#SBATCH -J baseline_train
#SBATCH -o baseline_train.out_%j
#SBATCH -e baseline_train.err_%j
#SBATCH -p gpu
#SBATCH --nodes=1
...
srun python3 /wrk/xiehuang/DONOTREMOVE/FSD2018/baseline/main.py

# This script will print some usage statistics to the
# end of file: baseline_train.out
