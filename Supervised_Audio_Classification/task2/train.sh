...
# author: xiehuang
#SBATCH -J task2_train
#SBATCH -o task2_train.out_%j
#SBATCH -e task2_train.err_%j
#SBATCH -p gpu
#SBATCH --nodes=1
...
srun python3 /wrk/xiehuang/DONOTREMOVE/FSD2018/task2/main.py

# This script will print some usage statistics to the
# end of file: task2_train.out
