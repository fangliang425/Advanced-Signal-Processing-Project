...
def parse_flags():
    parser = argparse.ArgumentParser(description='DCASE 2018 Task 2 VGG')
    ...
    training_group.add_argument(
        '--train_dir', type=str, default='/wrk/xiehuang/DONOTREMOVE/FSD2018/task/train_ckpt',
    ...
    eval_inference_group.add_argument(
        '--checkpoint_path', type=str, default='/wrk/xiehuang/DONOTREMOVE/FSD2018/task/train_ckpt/model.ckpt-<N>',
    ...
    inference_group.add_argument(
        '--predictions_csv_path', type=str, default='/wrk/xiehuang/DONOTREMOVE/FSD2018/task/predictions.csv',
